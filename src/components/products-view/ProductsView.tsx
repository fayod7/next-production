    ...
    <div className="grid grid-cols-4 gap-3 container py-[30px] max-[990px]:grid-cols-3 max-[750px]:grid-cols-2 max-[470px]:grid-cols-1">
      {
        products?.map((product:IProduct) => (
            <div key={product?.id} className="flex flex-col gap-0.5 border-gray-200 border bg-white overflow-hidden group"> 
                <div className="w-full overflow-hidden aspect-[4/3] relative group">
